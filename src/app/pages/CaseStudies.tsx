        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="text-center mb-20" dir={isRTL ? 'rtl' : 'ltr'}>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight">
              {isRTL ? 'פרוייקטים מובילים' : 'Top Projects'}
            </h1>
              ...
              >
                ...
                {project.liveUrl ? (
                  <a
                    ...
                    className="mx-8 mb-8 flex items-center gap-3 text-gray-700 bg-gradient-to-l from-green-50 to-emerald-50 px-5 py-3 rounded-2xl hover:from-green-100 hover:to-emerald-100 transition-colors"
                  >
                    <Globe className="w-6 h-6 text-green-600" />
                    <span className="font-bold text-lg break-all">
                      {formatDisplayUrl(project.liveUrl)}
                    </span>
                  </a>
                ) : (
                  <div className="mx-8 mb-8 flex items-center gap-3 text-gray-700 bg-gradient-to-l from-green-50 to-emerald-50 px-5 py-3 rounded-2xl">
                    <Globe className="w-6 h-6 text-green-600" />
                    <span className="font-bold text-lg break-all">{isRTL ? project.resultHe : project.resultEn}</span>
                  </div>
                )}
              </div>
            ))}
